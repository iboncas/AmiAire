...
DEFAULT_OUTPUT_DIR = "iteration1/output/analysis/kmeans"


def require_kmeans() -> Any:
    try:
        from sklearn.cluster import KMeans
    except ImportError as error:
        raise SystemExit(
            "scikit-learn is required for phase 8 K-means. "
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the K-means benchmark.")
    ...
    parser.add_argument("--kmeans-n-init", type=int, default=50, help="Number of random initializations")
    ...
    for feature_space in feature_spaces:
        ...
        for k_value in k_values:
            ...
            labels, confidence, extras = fit_predict_kmeans(
                features,
                candidate,
                random_seed=args.random_seed,
            )
            ...
            repeat_mean_ari, repeat_std_ari = compute_repeat_stability(
                ...
                fit_predict=fit_predict_kmeans,
    ...
    silhouette_plot = plot_metric_by_k(
        ...
        title="K-means silhouette benchmark",
